                            ...
                            {menuDetails.map((val1, index) => {
                                ...
                                return <tr key={index}>
                                    ...
                                    <td>
                                        ...
                                        <Link to={`/booking/${val1.id}`} className="btn btn-outline-success btn-sm">Book</Link> {" "}
                                        <Link to={`/delivery/${val1.id}`} className="btn btn-outline-primary btn-sm">Delivery</Link> {" "}
                                        <Link to={`/subscription/${val1.id}`} className="btn btn-outline-warning btn-sm">Subscribe</Link>
                                    </td>
